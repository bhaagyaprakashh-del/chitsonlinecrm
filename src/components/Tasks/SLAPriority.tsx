...
import { Plus, Search, Filter, Calendar, Clock, User, Tag, AlertTriangle, Star, MoreVertical, Edit, Trash2, Eye, Settings, Users, Target, TrendingUp, CheckCircle, XCircle, Save, X, Shield, Zap, Crown } from 'lucide-react';
