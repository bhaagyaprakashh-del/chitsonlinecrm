...
export const TasksReports: React.FC = () => {
  ...
  const reports = [
    {
      ...
      description: 'Team productivity analysis with completion rates',
      icon: TrendingUp,
      color: 'bg-blue-500',
    ...
    },
    {
      ...
      description: 'Customer support metrics with SLA compliance',
      icon: Target,
      color: 'bg-green-500',
  ...
  const quickStats = [
    { label: 'Total Tasks', value: '89', icon: CheckCircle, color: 'text-blue-400' },
    { label: 'Completed Today', value: '12', icon: Award, color: 'text-green-400' },
    { label: 'Overdue Tasks', value: '3', icon: AlertTriangle, color: 'text-red-400' },
    { label: 'Open Tickets', value: '24', icon: Flag, color: 'text-yellow-400' },
    { label: 'SLA Compliance', value: '91.2%', icon: Target, color: 'text-purple-400' },
    { label: 'Avg Resolution', value: '6.3h', icon: Clock, color: 'text-orange-400' }
  ];
  ...
  return (
    <div className="h-full flex flex-col bg-slate-900 overflow-hidden">
      ...
      <div className="flex justify-between items-center p-4 border-b border-yellow-400/30 flex-shrink-0">
        <div>
          <h1 className="text-2xl font-bold text-slate-50">Tasks & Tickets Reports</h1>
          <p className="mt-1 text-sm text-slate-400">
            Comprehensive analytics for task management and customer support
          </p>
        </div>
          ...
          <div className="bg-slate-800/40 backdrop-blur-xl rounded-2xl p-6 border border-yellow-400/30">
            ...
            <div className="h-64 flex items-center justify-center border-2 border-dashed border-yellow-400/30 rounded-xl">
              <div className="text-center">
                ...
                <p className="text-slate-400">Task Trends Chart</p>
          ...
          <div className="bg-slate-800/40 backdrop-blur-xl rounded-2xl p-6 border border-yellow-400/30">
            ...
            <div className="h-64 flex items-center justify-center border-2 border-dashed border-yellow-400/30 rounded-xl">
              <div className="text-center">
                ...
                <p className="text-slate-400">Category Chart</p>
                <p className="text-slate-500 text-sm">Interactive chart coming soon</p>
              </div>
            </div>
          </div>
