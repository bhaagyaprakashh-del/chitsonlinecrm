...
export const LeadsReports: React.FC = () => {
  ...
  const reports = [
    {
      ...
      description: 'Comprehensive pipeline analysis with conversion metrics',
      icon: TrendingUp,
      color: 'bg-blue-500',
    ...
    },
    {
      ...
      description: 'Win/loss analysis with detailed conversion metrics',
      icon: Target,
      color: 'bg-green-500',
    ...
    },
    {
      ...
      description: 'ROI and effectiveness of different lead sources',
      icon: Activity,
      color: 'bg-orange-500',
    ...
    },
    {
      ...
      description: 'CAC analysis across different channels and campaigns',
      icon: Users,
  ...
  const quickStats = [
    { label: 'Total Leads', value: '247', icon: Users, color: 'text-blue-400' },
    { label: 'Conversions', value: '42', icon: Award, color: 'text-green-400' },
    { label: 'Pipeline Value', value: '₹45.2L', icon: DollarSign, color: 'text-purple-400' },
    { label: 'Avg Deal Size', value: '₹3.8L', icon: Target, color: 'text-orange-400' },
    { label: 'Conversion Rate', value: '17.2%', icon: TrendingUp, color: 'text-emerald-400' },
    { label: 'Avg Sales Cycle', value: '8.5d', icon: Clock, color: 'text-yellow-400' }
  ];
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6 scrollbar-none">
          ...
          <div className="bg-slate-800/40 backdrop-blur-xl rounded-2xl p-6 border border-yellow-400/30">
            ...
            <div className="h-64 flex items-center justify-center border-2 border-dashed border-yellow-400/30 rounded-xl">
              <div className="text-center">
                ...
                <p className="text-slate-400">Pipeline Chart</p>
          ...
          <div className="bg-slate-800/40 backdrop-blur-xl rounded-2xl p-6 border border-yellow-400/30">
            ...
            <div className="h-64 flex items-center justify-center border-2 border-dashed border-yellow-400/30 rounded-xl">
              <div className="text-center">
                ...
                <p className="text-slate-400">Source Distribution Chart</p>
                <p className="text-slate-500 text-sm">Interactive chart coming soon</p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-slate-800/40 backdrop-blur-xl rounded-2xl p-6 border border-yellow-400/30">
          ...
          <div className="space-y-3">
            {[
              { action: 'New lead "TechCorp Solutions" added to pipeline', time: '2 hours ago', type: 'success' },
              { action: 'Proposal sent to "Manufacturing Ltd"', time: '4 hours ago', type: 'info' },
              { action: 'Deal closed with "Business Consultancy" - ₹3,00,000', time: '1 day ago', type: 'success' },
              { action: 'Follow-up scheduled with "Retail Chain Pvt Ltd"', time: '2 days ago', type: 'info' },
              { action: 'Lead "Construction Co" marked as lost', time: '3 days ago', type: 'warning' }
            ].map((activity, index) => (
